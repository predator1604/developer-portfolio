...
public sealed class SkillGroup : BaseEntity
{
    ...
    public static SkillGroup Create(string groupId, string title, string category, string accentColor, string accentBg, string iconPath, List<Skill> skills, List<string> tools, int sortOrder)
    {
