...
public sealed class Project : BaseEntity
{
    ...
    public void Update(string title, string category, string description, List<string> stack, string status, string statusLabel, bool isVisible, string? feature = null, string? liveUrl = null, string? gitHubUrl = null)
    {
        Title = title;
        Category = category;
        Description = description;
